document.addEventListener("DOMContentLoaded", function() {
  ...
  class FormSteps {
    ...
    updateSubmission(){
      ...
      let categoriesNames = document.querySelectorAll("#category");
      categoriesNames.forEach(function (element) {
        if (element.checked) {
     ...
     const numberOfBags = document.getElementById("bags");
      numberOfBags.innerText = numberOfBagsText.concat(" ",categories);
      ...
      institutionSum.innerText = institution;
